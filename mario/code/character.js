    ...
    if(datas != ""){
        ...
        if(obj.type == "incomingData"){
            ...
            if(obj.data[0].type == "pyrData"){
                if((Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Left) || obj.data[0].roll < -50 )&& !this.Ducking){ //Moving backward
                ...
                }else if((Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Right) || obj.data[0].roll > 50) && !this.Ducking){ //Moving forward
                    roll = obj.data[0].roll;
                    if (this.Facing === -1) {
                        this.Sliding = false;
                    }
               ...
               if(obj.data[0].pitch < -40  || (this.JumpTime < 0 && !this.OnGround && !this.Sliding)){
                    if (this.JumpTime < 0) {
                        this.Xa = this.XJumpSpeed;
                        this.Ya = -this.JumpTime * this.YJumpSpeed;
                        this.JumpTime++;
